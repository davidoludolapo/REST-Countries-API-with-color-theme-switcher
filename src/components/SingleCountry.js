        ...
        {country.map((item) => (
          ...
          >
            ...
            <article>
              ...
              <ul className="mt-4 flex flex-col items-start justify-start gap-2 text-slate-700 my-4 dark:text-gray-400">
              ...
              <Link to="/" className="inline-block mt-8 bg-white py-2 px-6 text-gray-700 hover:bg-gray-200 transition-all duration-200 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-400">&larr; Back</Link>
            </article>
          </div>
        ))}
      </section>
